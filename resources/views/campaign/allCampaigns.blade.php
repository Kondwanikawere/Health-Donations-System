...
@section('content')
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        <div class="relative flex justify-end overflow-x-auto  sm:rounded-lg">
            <a href="{{ route('activeCampaigns') }}" class="ml-1 text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 shadow-lg shadow-blue-500/50 dark:shadow-lg dark:shadow-blue-800/80 font-medium rounded-lg vs:!text-[12px] sm:!text-[16px] px-5 py-2.5 text-center me-2 mb-2 ">
                Active Campaigns
            </a>
            <a href="{{ route('nonActiveCampaigns') }}" class="ml-5 text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 shadow-lg shadow-blue-500/50 dark:shadow-lg dark:shadow-blue-800/80 font-medium rounded-lg vs:!text-[12px] sm:!text-[16px] px-5 py-2.5 text-center me-2 mb-2 ">
        ...
        <div class="text-center">
           @if(@session('status'))
            ...
            @endif
            <h1 class="pb-2">All Campaigns</h1>
        </div>
