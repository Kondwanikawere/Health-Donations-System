...
<body>
    ...
    <aside id="default-sidebar" class="fixed top-0 left-0 z-20 bg-white pt-16 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
    ...
    <main class="dashboard-content" class="p-4  sm:ml-64">
        <div class="p-4 pt-16 sm:ml-64">

            <div class="p-4 border-2 border-gray-200 bg-gray-100  rounded-lg dark:border-gray-700">
                @yield('content')
            </div>
        </div>
    </main>
