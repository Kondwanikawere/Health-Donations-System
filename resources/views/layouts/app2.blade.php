...
<body>
        ...
        <div class="px-3 py-3 lg:px-5 lg:pl-3">
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start">
                    <button data-drawer-target="default-sidebar" data-drawer-toggle="default-sidebar" aria-controls="default-sidebar" type="button" class="inline-flex items-center p-2 mt-2 ms-3 text-sm text-gray-500 rounded-lg vlg:!hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
                    ...
                    <form action="#" method="GET" class="hidden vlg:!block vlg:pl-3.5">
    ...
    <aside id="default-sidebar" class="fixed top-0 left-0 z-40 bg-white pt-16 w-45 sm:!w-64 h-screen transition-transform -translate-x-full vlg:!translate-x-0"  aria-labelledby="default-sidebar">
        <div class="h-full px-3 py-4 overflow-y-auto  dark:bg-gray-800">
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="{{ route('healthWorker')}}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">healthWorkers</span>
                    </a>
                </li>
                <li>
                    <span  class="flex items-center px-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                            <path d="m17.418 3.623-.018-.008a6.713 6.713 0 0 0-2.4-.569V2h1a1 1 0 1 0 0-2h-2a1 1 0 0 0-1 1v2H9.89A6.977 6.977 0 0 1 12 8v5h-2V8A5 5 0 1 0 0 8v6a1 1 0 0 0 1 1h8v4a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1v-4h6a1 1 0 0 0 1-1V8a5 5 0 0 0-2.582-4.377ZM6 12H4a1 1 0 0 1 0-2h2a1 1 0 0 1 0 2Z"/>
                        </svg>
                        <span class="flex-1 ms-3 whitespace-nowrap">
                                <button id="dropdownButton1" data-dropdown-toggle="dropdownHover" data-dropdown-trigger="hover" class="text-black rounded-lg text-sm px-0 py-2.5 text-center inline-flex items-center" type="button">
                                    <span class="text-base"> Patients </span>
                                ...
                                <div id="dropdownMenu1" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownButton1">
                                        <li>
                                            <a href="{{ route('viewAllPatients') }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">All Patients</a>
                                        </li>
                                        <li>
                                            <a href="{{ route('viewAcceptedPatients') }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Accepted Patients</a>
                                        </li>
                                        <li>
                                            <a href="{{ route('viewDeniedPatients') }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Denied Patients</a>
                                        </li>
                                        <li>
                                            <a href="{{ route('viewPendingPatients') }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Patients on Pending</a>
                                        </li>
                                        <li>
                                            <a href="{{ route('viewHelpReceived') }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Help Received</a>
                                        </li>
                                    </ul>
                                </div>
                        </span>
                ...
                <li>
                    <span  class="flex items-center px-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">
                                <button id="dropdownButton2" data-dropdown-toggle="dropdownHover" data-dropdown-trigger="hover" class="text-black rounded-lg text-sm px-0 py-2.5 text-center inline-flex items-center" type="button">
                                    <span class="text-base"> Donations </span>
                                    <svg class="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
                                    </svg>
                                </button>
                                ...
                                <div id="dropdownMenu2" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownButton2">
                                        <li>
                                            <a href="{{ route('viewPatientsDonations') }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">All Donations</a>
                                        </li>
                                        <li>
                                            <a href="{{ route('viewAllCampaigns') }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Donation Campains</a>
                                        </li>
                                        <li>
                                            <a href="{{ route('viewAllDonors') }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Donors</a>
                                        </li>
                                    </ul>
                                </div>
                        </span>
                ...
                <li>
                    <a href="{{ route('viewReport') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
    ...
    <main class="dashboard-content" class="p-4 vlg:ml-64 ">
        <div class="pt-16 vlg:ml-64 ">

            <div class="p-4 border-2 border-gray-200 bg-gray-100  rounded-lg dark:border-gray-700 h-[1424px]">
                @yield('content')
            </div>
        </div>
    </main>
    ...
    //table2
    if (document.getElementById("export-table2") && typeof simpleDatatables.DataTable !== 'undefined') {
        ...
        const table = new simpleDatatables.DataTable("#export-table2", {
            template: (options, dom) => "<div class='" + options.classes.top + "'>" +
                "<div class='flex flex-col sm:flex-row sm:items-center space-y-4 sm:space-y-0 sm:space-x-3 rtl:space-x-reverse w-full sm:w-auto'>" +
                (options.paging && options.perPageSelect ?
                        "<div class='" + options.classes.dropdown + "'>" +
    ...
    //table3
    if (document.getElementById("export-table3") && typeof simpleDatatables.DataTable !== 'undefined') {
            ...
            const table = new simpleDatatables.DataTable("#export-table3", {
                template: (options, dom) => "<div class='" + options.classes.top + "'>" +
                    "<div class='flex flex-col sm:flex-row sm:items-center space-y-4 sm:space-y-0 sm:space-x-3 rtl:space-x-reverse w-full sm:w-auto'>" +
                    (options.paging && options.perPageSelect ?
                            "<div class='" + options.classes.dropdown + "'>" +
    ...
    <script>
        ...
        const $targetEl1 = document.getElementById('dropdownMenu1');

        // set the element that trigger the dropdown menu on click
        const $triggerEl1 = document.getElementById('dropdownButton1');
        ...
        const dropdown1 = new Dropdown($targetEl1, $triggerEl1, options1, instanceOptions1);

        //dropdown2
        // set the dropdown menu element
        const $targetEl2 = document.getElementById('dropdownMenu2');

        // set the element that trigger the dropdown menu on click
        const $triggerEl2 = document.getElementById('dropdownButton2');
        ...
        const dropdown2 = new Dropdown($targetEl2, $triggerEl2, options2, instanceOptions2);
