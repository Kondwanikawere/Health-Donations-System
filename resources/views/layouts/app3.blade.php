...
<body class="bg-gray-100 dark:bg-gray-900">
    ...
    <div class="flex">
        ...
        <aside id="default-sidebar" class="fixed top-0 z-20 left-0  flex flex-col flex-shrink-0 hidden w-64 h-full pt-16 font-normal duration-75 lg:flex transition-width" aria-label="Sidebar">
