    ...
    <div class="flex items-center ">
        <!-- Circle Progress -->
        <div class="relative flex items-center justify-center w-12 h-12 sm:w-24 sm:h-24 bg-gray-200 rounded-full ">
        ...
        <!-- Progress Detail -->
        <div class="ml-4 ">
            <p class="mb-2 text-gray-600 text-xs sm:text-sm">Total Patients</p>
