...
@section('content')
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        <div class="relative flex justify-end overflow-x-auto  sm:rounded-lg">
            <a href="{{ route('viewAcceptedPatients') }}" class="ml-1 text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 shadow-lg shadow-blue-500/50 dark:shadow-lg dark:shadow-blue-800/80 font-medium rounded-lg vs:!text-[12px] sm:!text-[16px] px-5 py-2.5 text-center me-2 mb-2 ">
                ACCEPTED PATIENTS
            </a>
            <a href="{{ route('viewDeniedPatients') }}" class="ml-5 text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 shadow-lg shadow-blue-500/50 dark:shadow-lg dark:shadow-blue-800/80 font-medium rounded-lg vs:!text-[12px] sm:!text-[16px] text-sm px-5 py-2.5 text-center me-2 mb-2 ">
                DENIED PATIENTS
            </a>
            <a href="{{ route('registerPatients') }}" class="ml-1 text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 shadow-lg shadow-blue-500/50 dark:shadow-lg dark:shadow-blue-800/80 font-medium rounded-lg vs:!text-[12px] sm:!text-[16px] text-sm px-5 py-2.5 text-center me-2 mb-2 ">
                REGISTER A PATIENT
            </a>
        </div>
        <div class="text-center">
           @if(@session('status'))
            ...
            @endif
            <h1 class="pb-2">PENDING ACCEPTION PATIENT's DETAIlS</h1>
        </div>
        ...
        <table id="export-table">
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td>
                    <form action="{{ route('acceptPatient', $patient->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <button type="submit" class="ml-1 text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 shadow-lg shadow-blue-500/50 dark:shadow-lg dark:shadow-blue-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 ">
                            Accept
                ...
                <td>
                    <form action="{{ route('denyPatient', $patient->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <button type="submit" class="ml-1 text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 shadow-lg shadow-blue-500/50 dark:shadow-lg dark:shadow-blue-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 ">
                            Deny
